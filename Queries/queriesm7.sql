...
--creation of nwe retirement info table
SELECT ri.emp_no,
    ri.first_name,
    ri.last_name,
de.to_date
...
--Department Retirees only sales
SELECT ce.emp_no,
ce.first_name,
ce.last_name,
d.dept_name
...
--Department Retirees sales and Development team
SELECT ce.emp_no,
ce.first_name,
ce.last_name,
d.dept_name
